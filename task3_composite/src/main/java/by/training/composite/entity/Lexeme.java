...
public class Lexeme implements Component {
     ...
     */
    private List<Component> wordAndPunctuation = new ArrayList<>();
    ...
    public String compose() {
        return wordAndPunctuation.stream()
    ...
    public Object getChild(final int index) {
        return wordAndPunctuation.get(index);
    }
}
