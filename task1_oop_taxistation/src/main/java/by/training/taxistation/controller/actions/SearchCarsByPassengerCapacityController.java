...
public class SearchCarsByPassengerCapacityController
        extends BaseActionController {
    /**
     * view initialisation.
     */
    private final SearchCarsByPassengerCapacityView view
            = new SearchCarsByPassengerCapacityView();
    /**
     ...
     */
    public SearchCarsByPassengerCapacityController(
    ...
    public void internalRun() {
        ...
        if (from > to) {
            ...
            List foundPassengerCars = menuHandler
                    .searchCarsByPassengerCapacity(from, to);
